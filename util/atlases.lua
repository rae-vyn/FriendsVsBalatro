...
SMODS.Atlas({key = "the_jam", px = 34, py = 34, path = "the_jam.png", atlas_table = "ANIMATION_ATLAS", frames = 21})
SMODS.Atlas({key = "the_laundry", px = 34, py = 34, path = "the_laundry.png", atlas_table = "ANIMATION_ATLAS", frames = 21})